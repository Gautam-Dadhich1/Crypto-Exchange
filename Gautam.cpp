...
int main()
{
    std::string clientId = "P6TGQTrl";                                        // Replace with your Client ID
    std::string clientSecret = "-_rbnZQOEqNpTuUqRbpY4uOnCKmmwvtYuqT3XYfJ4aA"; // Replace with your Client Secret
